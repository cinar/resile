...
- **Commit Messages**: Prefer descriptive commit messages that focus on 'Why' and 'What' without using Conventional Commit prefixes like 'feat:' or 'fix:'. ALWAYS use GPG signatures for all commits (e.g., `git commit -S -m "..."`).
